...
//================================================================================
/**
 * Enum used to define the different kinds of features in the native ExifTool
 * executable that this class can help you take advantage of.
 * <p/>
 * These flags are different from {@link Tag}s in that a "feature" is determined
 * to be a special functionality of the underlying ExifTool executable that
 * requires a different code-path in this class to take advantage of; for
...
public enum Feature {
	...
	/**
	 * Used to get the version of ExifTool required by this feature in order to
	 * work.
	 * 
