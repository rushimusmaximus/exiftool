...
public interface ExifToolService extends AutoCloseable {
	...
	public static class Factory {
		public static ExifToolService create(Feature... features) {
			return new ExifToolNew3(features);
		...
		public static ExifToolService create(int timeoutWhenKeepAliveInMillis,
				Feature... features) {
			return new ExifToolNew3(timeoutWhenKeepAliveInMillis, features);
	...
	/**
	 * Using ExifToolNew3 in daemon mode (-stay_open True) executes different code
